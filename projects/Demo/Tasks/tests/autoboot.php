...
// Tasks test registry — this project's Suites.
//
...
// (cd projects/Demo/Tasks), one with `bootgly test <index>` and a single case with
// `bootgly test <index> <case>`.
return new Suites(
   directories: [
      // The project's own suite — the signature contract of Tasks.Project.php:
      'tests/project/',
   ]
);
