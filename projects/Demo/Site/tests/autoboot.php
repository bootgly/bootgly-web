...
// Site test registry — this project's Suites.
//
...
// (cd projects/Demo/Site), one with `bootgly test <index>` and a single case with
// `bootgly test <index> <case>`.
return new Suites(
   directories: [
      // The project's own suite — the signature contract of Site.Project.php:
      'tests/project/',
   ]
);
